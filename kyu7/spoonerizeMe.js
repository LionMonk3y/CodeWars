// https://www.codewars.com/kata/56b8903933dbe5831e000c76/javascript
...
function spoonerize(words) {
  ...
  const firstWord = wordArray[0][0] + wordArray[1].substring(1);
  const secondWord = wordArray[1][0] + wordArray[0].substring(1);
