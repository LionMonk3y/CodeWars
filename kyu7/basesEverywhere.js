// https://www.codewars.com/kata/5f47e79e18330d001a195b55/javascript
...
function baseFinder(sequence) {
  const sortedSequence = sequence.sort((a, b) => parseInt(a) - parseInt(b));
  const uniqueDigits = new Set();

  for (let num of sortedSequence.join("")) {
